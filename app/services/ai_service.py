...
ОБЩАЯ ХАРАКТЕРИСТИКА ЛИЧНОСТИ (600-700 слов)
- Детальный анализ с упоминанием имени {partner_name}
- Модель "Темной триады" с конкретными баллами
- Анализ каждого ответа с прямыми цитатами
- Влияние профессии и окружения на токсичные черты

ДОМИНИРУЮЩИЕ ПОВЕДЕНЧЕСКИЕ ПАТТЕРНЫ (700-800 слов)
- Основные токсичные черты {partner_name} с примерами
- Триггеры агрессивного поведения
- Способы манипуляций и контроля
- Эмоциональная нестабильность и её проявления

АНАЛИЗ ОТНОШЕНИЙ И ВЗАИМОДЕЙСТВИЙ (600-700 слов)
- Как {partner_name} строит отношения с разными людьми
- Паттерны общения в конфликтных ситуациях
- Способность к эмпатии и поддержке
- Реакция на успехи и неудачи окружающих

КРАСНЫЕ ФЛАГИ И ПРЕДУПРЕЖДАЮЩИЕ ЗНАКИ (500-600 слов)
- Конкретные примеры опасного поведения
- Эскалация конфликтов и агрессии
- Признаки психологического насилия
- Потенциальные риски для партнера

ПРОГНОЗ РАЗВИТИЯ ОТНОШЕНИЙ (600-700 слов)
- Вероятные сценарии развития событий
- Риски для физического и психологического здоровья
- Возможности изменения поведения {partner_name}
- Влияние на детей и семью

РЕКОМЕНДАЦИИ И СТРАТЕГИИ ЗАЩИТЫ (500-600 слов)
- Конкретные шаги для обеспечения безопасности
- Техники общения с {partner_name}
- Когда обращаться за профессиональной помощью
- Планы выхода из токсичных отношений
